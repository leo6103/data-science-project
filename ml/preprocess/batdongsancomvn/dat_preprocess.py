...
land_raw_directory = 'data/raw/batdongsancomvn/dat'
house_raw_directory = 'data/raw/batdongsancomvn/nharieng'

# Đọc dữ liệu thô 
list_paths_land =  merge_json_files(land_raw_directory)
list_paths_house =  merge_json_files(house_raw_directory)

raw_data = merge_data_with_paths(list_paths_land)
house_raw_data = merge_data_with_paths(list_paths_house)

print("Number sample in land raw data: ",len(raw_data))
print("Number sample in houses raw data: ",len(house_raw_data))
